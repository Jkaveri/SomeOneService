...
var pickPlace = function(user1, user2){
    'use strict';

    return new Place({
        name:'Cafe milano',
        address: '343 Pham Ngu Lao',
        state: null,
        ward: 'Pham Ngu Lao',
        district: '1',
        city: 'Ho Chi Minh',
        formatted: '343 Pham Ngu Lao, P. Pham Ngu Lao, Q. 1, tp. Ho Chi Minh',
        loc:[10.7673911, 106.6900831]
    });
};
                ...
                Q.allSettled(promises)
                    .then(function (results) {
                        ...
                        _.each(results, function (item) {
                            ...
                            // create appointment.
                            var appointment = pickAppointment(item[0], item[1]);
                            // select location.
                            var place = pickPlace(item[0], item[1]);
                            // notification.
